(() => {
    ...
    const PT_BR = {
        ...
        'Torrent Trackers': 'Trackers do torrent',
        'Select one torrent to view trackers.': 'Selecione um torrent para ver os trackers.',
        'Loading trackers...': 'Carregando trackers...',
        'No trackers available.': 'Nenhum tracker disponível.',
        'Failed to load torrent trackers.': 'Falha ao carregar os trackers do torrent.',
        'Message': 'Mensagem',
        'Torrents': 'Torrents',
        'torrents': 'torrents',
        'Select': 'Selecionar',
        ...
        'Peers': 'Peers',
        'Address': 'Endereço',
        'Torrent Peers': 'Peers do torrent',
        'Select one torrent to view peers.': 'Selecione um torrent para ver os peers.',
        'Loading peers...': 'Carregando peers...',
        'No peers available.': 'Nenhum peer disponível.',
        'Failed to load torrent peers.': 'Falha ao carregar os peers do torrent.',
        'Select a torrent.': 'Selecione um torrent.',
        'Select one torrent to view files.': 'Selecione um torrent para ver os arquivos.',
        'Loading files...': 'Carregando arquivos...',
        'No files available.': 'Nenhum arquivo disponível.',
        'Failed to load torrent files.': 'Falha ao carregar os arquivos do torrent.',
        'Do not download': 'Não baixar',
        'Normal': 'Normal',
        'High': 'Alta',
        'Priority': 'Prioridade',
        ...
        'No torrent client is connected.': 'Nenhum cliente de torrent está conectado.',
        'Failed to recheck one or more torrents.': 'Falha ao verificar novamente um ou mais torrents.',
        'Failed to reannounce one or more torrents.': 'Falha ao reanunciar um ou mais torrents.',
        'Failed to open download folder.': 'Falha ao abrir a pasta de download.',
        'Download folder is unavailable.': 'A pasta de download não está disponível.',
