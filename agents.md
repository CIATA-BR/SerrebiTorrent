...
- [libtorrent 2.1 compatibility](C:\Users\admin\.claude\projects\c--Users-admin-git-SerrebiTorrent\memory\libtorrent-21-compat.md) — issue #1: 2.1 removed torrent_status.paused/auto_managed (now status.flags bitmask) and session.status(); silent row-skip made added torrents invisible; use clients._torrent_status_flag/_torrent_state_value; tools/repro_add_invisible.py reproduces
